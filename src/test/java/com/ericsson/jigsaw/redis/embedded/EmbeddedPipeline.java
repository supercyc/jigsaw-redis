...
public class EmbeddedPipeline extends Pipeline {
    ...
    private List<EmbededResponse> responseList = new ArrayList<EmbededResponse>();
    ...
    protected <T> Response<T> getResponse(Builder<T> builder) {
        EmbededResponse response = new EmbededResponse(builder);
        responseList.add(response);
        return response;
    }

    private static class EmbededResponse extends Response {

        private Object data;

        public EmbededResponse(Builder builder) {
            super(builder);
        }
